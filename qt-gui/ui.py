...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionSettings = QtWidgets.QMenu(self.menubar)
        ...
        self.actionSettings.addAction(self.actionDefault)
        ...
        self.menubar.addAction(self.actionSettings.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionSettings.setTitle(_translate("MainWindow", "设置"))
